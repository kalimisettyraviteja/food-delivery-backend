...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendVerificationOtp(String toEmail, String name, String otp) {
        sendOtpMail(
                ...
                name,
                otp,
                "FoodDelivery - Verify Your Email",
                "VERIFY YOUR EMAIL"
        );
    }
    ...
    public void sendPasswordResetOtp(String toEmail, String name, String otp) {
        sendOtpMail(
                ...
                name,
                otp,
                "FoodDelivery - Password Reset OTP",
                "RESET YOUR PASSWORD"
        );
    }
                            ...
                            <div style="padding:34px 28px 22px 28px; text-align:center; border-bottom:1px solid #f1f5f9;">
                                ...
                                <div style="margin-top:28px; text-align:center; font-size:0;">
                                    <div style="display:inline-block; width:24%%; vertical-align:top;">
                                        <div style="width:68px; height:68px; line-height:68px; margin:0 auto 10px auto; border-radius:50%%; background:#fff1e8; font-size:30px;">
                                            🛵
                                        </div>
                                    ...
                                    <div style="display:inline-block; width:24%%; vertical-align:top; border-left:1px solid #e2e8f0;">
                                        <div style="width:68px; height:68px; line-height:68px; margin:0 auto 10px auto; border-radius:50%%; background:#eef8e8; font-size:30px;">
                                            🍽️
                                        </div>
                                    ...
                                    <div style="display:inline-block; width:24%%; vertical-align:top; border-left:1px solid #e2e8f0;">
                                        <div style="width:68px; height:68px; line-height:68px; margin:0 auto 10px auto; border-radius:50%%; background:#eaf3ff; font-size:30px;">
                                            ✅
                                        </div>
                                    ...
                                    <div style="display:inline-block; width:24%%; vertical-align:top; border-left:1px solid #e2e8f0;">
                                        <div style="width:68px; height:68px; line-height:68px; margin:0 auto 10px auto; border-radius:50%%; background:#fff6dd; font-size:30px;">
                                            😊
                                        </div>
